"""
Django settings for kawoola project.
...
SECRET_KEY = 'django-insecure-p&h=iepi9uvz9li#qk(59u(57c_^88#*-f^9=712+fkh2)ux59'
...
WSGI_APPLICATION = 'kawoola.wsgi.application'
